...
| schema_migrations | version VARCHAR(100) PK; applied_at TIMESTAMP. Bảng kỹ thuật, ngoài 10 bảng nghiệp vụ sau migration 002. |
...
`schema.sql` là chuỗi migration 001 + 002 để cài mới. DB đã có 001 chỉ áp dụng 002, không chạy lại schema/seed. Migration 002 bảo toàn tiến độ và đổi trạng thái cũ in_progress/completed thành IN_PROGRESS/COMPLETED. Tài liệu/ảnh trong `homework/` là minh chứng phiên bản 001 (10 bảng), không phải schema tích hợp mới (11 bảng).
